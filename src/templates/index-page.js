    ...
    <Main type='primary'>
          ...
          <TwoCol flex='start'>
            ...
            <div>
              ...
              <p>
                ...
                platform as well as the mission statement and goals, please view
                the following links.
              </p>
              <ButtonGroup>
                <Link to='/about'>
      ...
      >
        <Container type='small'>
          <h2>Get in Touch</h2>
          <p>
            If you have any ideas, questions, or concerns regarding the platform
            or its admin, Rebel Rabbits, please do not hesitate to get in touch.
          </p>
          <Link to='/contact'>
